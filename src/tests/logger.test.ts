...
describe('logger', () => {
  describe('log levels', () => {
    it('logs a message at the debug level', () => {
      ...
      expect(transport).toHaveBeenCalledWith('debug', 'This is a debug message', undefined);
    ...
    it('logs a message at the info level', () => {
      ...
      expect(transport).toHaveBeenCalledWith('info', 'This is an info message', undefined);
      expect(transport).toHaveBeenCalledTimes(1);
    });
    ...
    it('logs a message at the notice level', () => {
      ...
      expect(transport).toHaveBeenCalledWith('notice', 'This is a notice message', undefined);
      expect(transport).toHaveBeenCalledTimes(1);
    });
    ...
    it('logs a message at the warn level', () => {
      ...
      expect(transport).toHaveBeenCalledWith('warn', 'This is a warn message', undefined);
      expect(transport).toHaveBeenCalledTimes(1);
    });
    ...
    it('logs a message at the error level', () => {
      ...
      expect(transport).toHaveBeenCalledWith('error', 'This is an error message', undefined);
      expect(transport).toHaveBeenCalledTimes(1);
    });
    ...
    it('logs a message at the critical level', () => {
      ...
      expect(transport).toHaveBeenCalledWith('crit', 'This is a critical message', undefined);
      expect(transport).toHaveBeenCalledTimes(1);
    });
    ...
    it('logs a message at the alert level', () => {
      ...
      expect(transport).toHaveBeenCalledWith('alert', 'This is an alert message', undefined);
      expect(transport).toHaveBeenCalledTimes(1);
    });
    ...
    it('logs a message at the emergency level', () => {
      ...
      expect(transport).toHaveBeenCalledWith('emerg', 'This is an emergency message', undefined);
      expect(transport).toHaveBeenCalledTimes(1);
    });
  });
  ...
  describe('handling extra metadata', () => {
    describe('when including metadata in the logger call', () => {
      it('passes the metadata to the transport', () => {
        ...
        expect(transport).toHaveBeenCalledTimes(1);
        expect(transport).toHaveBeenCalledWith('debug', 'User logged in', metadata);
      });
    });
    ...
    describe('when metadata is not provided', () => {
      it('should not pass the metadata to the transport', () => {
        ...
        expect(transport).toHaveBeenCalledTimes(1);
        const [, , extra] = transport.mock.calls[0];
        expect(extra).toBeUndefined();
        expect(transport).toHaveBeenCalledWith('debug', 'User logged in', undefined);
      });
    });
  });
});
